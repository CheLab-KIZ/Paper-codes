...
treefile = 'Motacillidae_Motacilla_9sp.tre' 
outfilebase = 'Motacillidae_Motacilla'
total_diversity = 13
nTimeSlices = 1000
ngen_burnin = 200
ngen_mcmc = 100000
revscript = 'Motacillidae_Motacilla_classe.rev'

classe_state_datafile = 'Motacillidae_Motacilla_states.csv'
