...
treefile = 'Elaphe_Orthriophis_4sp.tre' 
outfilebase = 'Elaphe_Orthriophis'
total_diversity = 4
nTimeSlices = 1000
ngen_burnin = 200
ngen_mcmc = 100000
revscript = 'Elaphe_Orthriophis_classe.rev'

classe_state_datafile = 'Elaphe_Orthriophis_states.csv'
