...
treefile = 'Trogonidae_Harpactes_10sp.tre' 
outfilebase = 'Trogonidae_Harpactes'
total_diversity = 10
nTimeSlices = 1000
ngen_burnin = 200
ngen_mcmc = 2000
revscript = 'Trogonidae_Harpactes_classe.rev'

classe_state_datafile = 'Trogonidae_Harpactes_states.csv'
