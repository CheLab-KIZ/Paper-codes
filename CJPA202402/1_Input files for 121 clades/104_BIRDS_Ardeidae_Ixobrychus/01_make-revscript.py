...
treefile = 'Ardeidae_Ixobrychus_6sp.tre' 
outfilebase = 'Ardeidae_Ixobrychus'
total_diversity = 10
nTimeSlices = 1000
ngen_burnin = 200
ngen_mcmc = 100000
revscript = 'Ardeidae_Ixobrychus_classe.rev'

classe_state_datafile = 'Ardeidae_Ixobrychus_states.csv'
