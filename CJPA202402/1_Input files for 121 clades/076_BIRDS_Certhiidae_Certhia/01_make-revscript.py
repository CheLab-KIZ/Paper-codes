...
treefile = 'Certhiidae_Certhia_9sp.tre' 
outfilebase = 'Certhiidae_Certhia'
total_diversity = 9
nTimeSlices = 1000
ngen_burnin = 200
ngen_mcmc = 100000
revscript = 'Certhiidae_Certhia_classe.rev'

classe_state_datafile = 'Certhiidae_Certhia_states.csv'
