...
treefile = 'Zosteropidae_Yuhina_6sp.tre' 
outfilebase = 'Zosteropidae_Yuhina'
total_diversity = 7
nTimeSlices = 1000
ngen_burnin = 200
ngen_mcmc = 100000
revscript = 'Zosteropidae_Yuhina_classe.rev'

classe_state_datafile = 'Zosteropidae_Yuhina_states.csv'
