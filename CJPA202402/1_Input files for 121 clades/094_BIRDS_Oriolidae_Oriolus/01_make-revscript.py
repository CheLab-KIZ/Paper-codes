...
treefile = 'Oriolidae_Oriolus_25sp.tre' 
outfilebase = 'Oriolidae_Oriolus'
total_diversity = 30
nTimeSlices = 1000
ngen_burnin = 200
ngen_mcmc = 100000
revscript = 'Oriolidae_Oriolus_classe.rev'

classe_state_datafile = 'Oriolidae_Oriolus_states.csv'
